            ...
            >
              <nav className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col space-y-3 pt-4 border-t border-border-light">
                  <Link
                    href="/auth/login"
                    className="text-left text-text-primary font-medium py-2"
                  >
                    Sign In
                  </Link>
                  <Link
          ...
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="bg-surface-primary text-text-primary border border-border-default px-8 py-4 rounded-xl font-medium hover:bg-surface-secondary transition-all duration-200 flex items-center justify-center space-x-2">
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className="w-4 h-4 fill-current text-text-primary"
                    />
                  ))}
                </div>
      ...
      <section className="py-24 bg-surface-primary border-t border-border-light">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-4">
            ...
            <button className="bg-surface-primary text-text-primary border border-border-default px-8 py-4 rounded-xl font-medium hover:bg-surface-secondary transition-all duration-200">
              Contact Sales
            </button>
          </div>
        </div>
