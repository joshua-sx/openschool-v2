...
CREATE UNIQUE INDEX "account_links_account_tenant_active_unique" ON "account_links" USING btree ("account_id","tenant_id") WHERE "account_links"."status" = 'active';--> statement-breakpoint
