...
| `students` | runtime | approved capability and Student scope | `tenant.students.create` plus `WITH CHECK` | `tenant.students.update` plus `USING`/`WITH CHECK` | `tenant.students.delete` plus `USING` |
