...
This work does not make OpenSchool production-ready. Capability Policy Decisions and non-owner transaction-scoped database roles now govern the application seam, but forced RLS, atomic audit/outbox and durable invalidation, production invitation/MFA/support lifecycle, and the complete Isolation Matrix remain #87–#90.
