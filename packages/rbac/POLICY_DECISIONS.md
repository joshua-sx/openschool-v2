...
- `2026-08-13.v7` — current Tenant, platform, support, canonical learner, academic/enrollment, guardian-contact, and MFA-protected household templates;
- `2026-08-03.v6` — accepted rollback before household capabilities were enabled;
- `2026-08-03.v5` — accepted rollback before guardian-contact capabilities were enabled;
...
The focused policy suite proves default-deny inputs, order-independent multi-role union, guardian, student, teacher/class, School, Academic Year, School Enrollment, guardian contact, household, Organization subtree, support, and platform cases; MFA plus exact lifecycle audit obligations for academic, enrollment, contact, and household management; immutable custom composition; and accepted-version selection. `policy:query-poc`, academic structure, enrollment lifecycle, guardian-contact, and household/residence proofs run against disposable seeded PostgreSQL and prove Organization subtree, selected School, assigned class, current portal-eligible linked student, self, sibling-School, historical, and cross-Tenant data constraints.
