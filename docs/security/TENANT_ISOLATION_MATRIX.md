...
| School/class | assigned teacher and School admin reach canonical learners through current School Enrollment | valid sibling School/class and cross-Tenant admission denied | assignment and enrollment effective periods are resolved at query time | engineering gate |
