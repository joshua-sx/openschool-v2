...
| Tenant isolation evidence | Preview | [Matrix](./security/TENANT_ISOLATION_MATRIX.md), [gate](./security/ISOLATION_GATE.md), [machine-readable registry](../packages/isolation/src/matrix.ts) | Implemented M1 surfaces run through actual identities/adapters; unbuilt paths are disabled and production/legal/operations approval remains NO-GO |
