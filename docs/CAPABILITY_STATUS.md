...
| Possible duplicate People review | Preview | [Admin workflow](../apps/web/app/%28app%29/settings/duplicate-people), [operating contract](../packages/db/DUPLICATE_PEOPLE_REVIEW.md), [system proof](../apps/web/src/server/duplicate-people-poc.ts) | Admissions and contact creation surface bounded, explainable, nonblocking suggestions; authorized AAL2 administrators can confirm distinct People or request approval, but no Person merge execution or production approval exists |
